...
```text
You have access to a local skill named ssquant-ai-trader at:
<SSQUANT_AI_TRADER_SKILL_ROOT>

When the user request matches this skill's SKILL.md description:
1. Read <SSQUANT_AI_TRADER_SKILL_ROOT>/SKILL.md.
2. Follow the workflow and guardrails in that file exactly.
3. Load referenced files under <SSQUANT_AI_TRADER_SKILL_ROOT>/references/ only when needed.
